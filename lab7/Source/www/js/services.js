...
.service('LoginService', function($q, $http) {
  ...
  loginUser: function(name, pw) {
            ...
            var promise = deferred.promise;
             ...
             $http({
        method: 'GET',
        url: 'https://api.mongolab.com/api/1/databases/lab7/collections/userdata?q={username:\''+name+'\'}&apiKey=rCyYaCPdjT1iurRC_a9Ct4aa9-03n_WI',
...
.service('DeleteService', function($q, $http) {
    return {
        ...
        contentType:"application/json"
          ...
          $http({
              method: 'DELETE' ,   
        url: 'https://api.mongolab.com/api/1/databases/lab7/collections/userdata/'+data[0]._id.$oid+'?apiKey=rCyYaCPdjT1iurRC_a9Ct4aa9-03n_WI',
  ...
  .service('UpdateService', function($q, $http) {
    return {
         ...
         updateUser:function(data) {
          ...
          $http({
              method: 'PUT' ,   
        url: 'https://api.mongolab.com/api/1/databases/lab7/collections/userdata/'+data.id+'?apiKey=rCyYaCPdjT1iurRC_a9Ct4aa9-03n_WI',
...
.service('RegisterService', function($q, $http) {
    return {
        RegisterUser: function(fname, lname,username, password) {
          ...
          $http({
        method: 'POST',
        url: 'https://api.mongolab.com/api/1/databases/lab7/collections/userdata?apiKey=rCyYaCPdjT1iurRC_a9Ct4aa9-03n_WI',
        data: JSON.stringify({
       firstname: fname,
        lastname: lname,
        username: username,
